...
class SSDNet(object):
    """Implementation of the SSD VGG-based 640 network.
    ...
    def update_feature_shapes(self, predictions):
        ...
        array).
        """
        shapes = base640.ssd_feat_shapes_from_net(predictions, self.params.feat_shapes)
        self.params = self.params._replace(feat_shapes=shapes)
    ...
    def losses(self, logits, localisations,
        ...
        """
        return base.ssd_losses(logits, localisations,
                          gclasses, glocalisations, gscores,
